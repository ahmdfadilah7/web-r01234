            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['method' => 'post', 'route' => ['satuan.update', $satuan->id], 'enctype' => 'multipart/form-data']) !!}
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keterangan" class="form-control" value="{{ $satuan->keterangan }}">
