        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                @if(Request::segment(2)=='barang')
                    <a href="{{ route('penjualan.barang.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                @else
                    <a href="{{ route('penjualan.aksesoris.add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                @endif
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row page-titles mx-0">
                            <div class="col-sm-12 p-md-0">
                                {!! Form::open(['method' => 'post', 'route' => ['penjualan.export']]) !!}
...
<script type="text/javascript">
    $(function() {
        var table = $('#example1').DataTable({
            ...
            @if (Request::segment(2)=='barang')
                ajax: {
                    url: "{{ route('penjualan.list', 'barang') }}",
                    data: function(d) {}
                },
            @else
                ajax: {
                    url: "{{ route('penjualan.list', 'aksesoris') }}",
                    data: function(d) {}
                },
            @endif
            columns: [
