            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::open(['method' => 'post', 'route' => ['barang.update', $barang->id], 'enctype' => 'multipart/form-data']) !!}
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_barang_value" class="form-control" value="{{ $barang->kode_barang }}" readonly>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="merk_barang" class="form-control" value="{{ $barang->merk_barang }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori_id" class="form-control">
                                            ...
                                            @foreach($kategori as $row)
                                                <option value="{{ $row->id }}" @if($row->id==$barang->kategori_id) {{ 'selected' }} @endif>{{ $row->nama_kategori }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="satuan_id" class="form-control">
                                            ...
                                            @foreach($satuan as $row)
                                                <option value="{{ $row->id }}" @if($row->id==$barang->satuan_id) {{ 'selected' }} @endif>{{ $row->nama_satuan.' - '.$row->keterangan }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ url($barang->gambar_barang) }}" width="70">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi_barang" class="form-control summernote" rows="5">{{ $barang->deskripsi_barang }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
